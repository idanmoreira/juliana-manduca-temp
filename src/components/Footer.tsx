const Footer = () => {
  return <footer className="py-12 px-4 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-[#161627] to-[#2C214A]">
        <img src="/lovable-uploads/b3ef6201-24e6-486e-b0d3-96af8b86b89c.png" alt="Ancient stone bridge" className="absolute inset-0 w-full h-full object-cover opacity-5" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <div className="backdrop-blur-md bg-white/5 rounded-2xl p-8 border border-white/10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <a href="https://www.instagram.com/juliana.manduca/" target="_blank" rel="noopener noreferrer" className="text-[#FBEBBD] hover:text-[#F3C63E] transition-colors duration-300 flex items-center gap-2 px-6 py-3 rounded-full border border-white/20 hover:border-[#F3C63E]/50">
