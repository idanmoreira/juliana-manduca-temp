...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled ? 'backdrop-blur-md bg-[#161627]/80 shadow-lg' : 'bg-transparent'
    }`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8">
            <button 
              ...
              className="text-[#FBEBBD] hover:text-[#F3C63E] transition-colors duration-300"
            >
              Início
            </button>
            <button 
            ...
            <button 
              onClick={() => scrollToSection('human-design')}
              className="text-[#FBEBBD] hover:text-[#F3C63E] transition-colors duration-300"
            >
              Desenho Humano
            </button>
