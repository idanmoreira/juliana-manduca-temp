  ...
  return <section className="py-20 px-4 relative overflow-hidden" id="human-design">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="backdrop-blur-md bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
          {isMobile ? <iframe id="chartWidget" src="https://neutrinoplatform.com/widget/chart/new?apiKey=6dc1fa162b1dda904f9649f365496e3d9fe0166f&mobile=1" style={{
          width: '100%',
          height: '450px'
        }} frameBorder="0" className="rounded-xl" /> : <iframe id="chartWidget" src="https://neutrinoplatform.com/widget/chart/new?apiKey=6dc1fa162b1dda904f9649f365496e3d9fe0166f" style={{
          width: '100%',
          height: '450px'
        }} frameBorder="0" className="rounded-xl" />}
        </div>
      </div>
    </section>;
};
